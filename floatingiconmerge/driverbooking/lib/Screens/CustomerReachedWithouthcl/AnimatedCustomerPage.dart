...
class AnimatedCustomerPage extends StatefulWidget {
  const AnimatedCustomerPage({super.key});

  @override
  State<AnimatedCustomerPage> createState() => _AnimatedCustomerPageState();
}

class _AnimatedCustomerPageState extends State<AnimatedCustomerPage> with SingleTickerProviderStateMixin {
            ...
            children: [
              ...
              Flexible(
                child: SizedBox(
                  ...
                  child: Lottie.asset(
                    'assets/animations/Animationed.json',
                    fit: BoxFit.contain,
                  ),
                ),
              ),
