...
class AnimatedCabHeader extends StatefulWidget {
  @override
  _AnimatedCabHeaderState createState() => _AnimatedCabHeaderState();
}

class _AnimatedCabHeaderState extends State<AnimatedCabHeader> with SingleTickerProviderStateMixin {
